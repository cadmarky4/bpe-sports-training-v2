...
function get_DB_CONFIG__From_ENV_File(string $ENV_File):mixed {
    ...
    if ($database_url) {
        ...
        $DB_CONFIG_arr["DB_Port"] = $parsed['port'] ?? 55340;  // Changed from 3306 to 55340
        ...
        $DB_CONFIG_arr["DB_Port"] = getenv("MYSQL_PORT") ?: "55340";
...
$db = db::open('mysqli', $DB_CONFIG['DB_Name'], $DB_CONFIG['DB_User'], $DB_CONFIG['DB_Pass'], $DB_CONFIG['DB_Host'], 55340);
//Init DB ###############################################
