...
$no_forms_css = true;
require($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'php/inc.html_head.php');
//######################################################
?>
<?php /* //debug for mobiles with no console
<script type="text/javascript" src="https://getfirebug.com/firebug-lite-debug.js"></script>*/?>

<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/chosen/chosen.min.css" />
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/chosen/chosen.jquery.min.js"></script>
 
<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>css/coolfieldset.css?<?=$G_VER;?>" />
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/jquery.collapsibleFieldset.js?<?=$G_VER;?>"></script>

<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bootstrap/dist/css/bootstrap-theme.min.css">
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bootstrap/dist/js/bootstrap.min.js"></script>

<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/moment/min/moment.min.js"></script>
<?php if ($LANG->LANG_CURRENT != 'en') { ?>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/overrides/moment/<?=$LANG->LANG_CURRENT;?>.js"></script>
<?php } ?>
<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css" />
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>

<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bootstrap-multiselect/dist/css/bootstrap-multiselect.css"/>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bootstrap-multiselect/dist/js/bootstrap-multiselect.min.js"></script>
<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>

<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/jquery-validation/dist/jquery.validate.js"></script>
<?php if ($LANG->LANG_CURRENT != 'en') { ?>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/overrides/query-validation/messages_<?=$LANG->LANG_CURRENT;?>.min.js"></script>
<?php } ?>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/bs-confirmation/bootstrap-confirmation.min.js"></script>

<script src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/highcharts/highcharts.js"></script>
<script src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/highcharts/modules/no-data-to-display.js"></script>

<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/lang_<?=$LANG->LANG_CURRENT;?>.js<?=$G_VER;?>"></script>
<script>
...
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/common.js<?=$G_VER;?>"></script>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>results/js/diagram_functions.js<?=$G_VER;?>"></script>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>results/js/axis.js<?=$G_VER;?>"></script>

<link rel="stylesheet" type="text/css" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>results/css/results.css">
<style type="text/css">
		...
		<div class="col-sm-8">
		  <form id="save_form">
			...
			<div style="text-align:right;">
				<span class="help_colors" title="<img src='<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>img/highcharts_colors.png' class='img_colors'/>">
				<span class="help_question">?</span> <?=$LANG->RESULTS_INFO_STANDARD_COLORS;?></span> &nbsp; &nbsp; 
				<span class="help_lines" title="<img src='<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>img/chart_lines_<?=$LANG->LANG_CURRENT;?>.png' class='img_lines'/>">
