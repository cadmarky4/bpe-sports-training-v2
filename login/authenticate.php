...
require_once($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'php/inc.date_functions.php');


$login = $PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'login.php'; //login page
$success = $PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY; //index page
...
//Init DB #######################
require_once($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'php/class.db.php');	
