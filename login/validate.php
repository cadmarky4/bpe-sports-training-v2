...
require_once(__DIR__.'/'.$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'_settings.regmon.php');

require_once(__DIR__.'/'.$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'login/inc.login_functions.php');


$login = $PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.$CONFIG['REGmon_Folder'].'login.php'; //login page
$logout = $PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.$CONFIG['REGmon_Folder'].'login/logout.php'; //logout page
