...
require_once($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'export/inc.export_functions.php');
require_once($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'php/inc.categories_functions.php');
...
?>
<?php /*<!-- Jquery -->*/?>
<link type="text/css" rel="stylesheet" href="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>node_modules/jquery-ui/dist/themes/smoothness/jquery-ui.min.css">
...
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/export/table2CSV.js<?=$G_VER;?>"></script>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/export/xlsx.core.min.js"></script>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/export/Blob.js"></script>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/export/FileSaver.js"></script>
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>js/plugins/export/Export2Excel.js"></script>
...
<script type="text/javascript" src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>export/js/export.js<?=$G_VER;?>"></script>
<style>
...
<body>
	<?php //require($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'php/inc.header.php');?>
	...
	<?php if (!$no_data) { ?>	
			<div id="bottom-wizard">
				<h4>
					...
					<br>.
					<span id="download_XLS" class="download_ico"><img src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>img/xls.png"></span>
					<span id="download_XLSX" class="download_ico"><img src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>img/xlsx.png"></span>
					<span id="download_CSV" class="download_ico"><img src="<?=$PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY;?>img/csv.png"></span>
				</h4>
			</div>
	<?php } ?>
		</div>
	...
	<?php //require($PATH_2_rgikBOGeTxNzMAcrsrFnIQzQaNXenZTY.'php/inc.footer.php');?>
